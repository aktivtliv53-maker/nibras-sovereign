...
# الإصدار: الربط المداري الحتمي - مع حل مشكلة الحروف العمودية
...
# ==============================================================================
st.set_page_config(page_title="Nibras v28.1", page_icon="🛡️", layout="wide")
...
with st.sidebar:
    ...
    <div style='text-align:center;'>
        ...
        <p>الإصدار v28.1 - الربط المداري</p>
        <p>المستخدم: محمد</p>
    </div>
    ---
    <div>
    ...
    if st.button("🚀 تفعيل المفاعل السيادي v28.1", use_container_width=True):
        if full_text.strip():
            ...
            if bodies:
                ...
                # ============================================================
                # رسم بياني ثابت (بدون حلقة for - لا يسبب عمود حروف)
                # ============================================================
